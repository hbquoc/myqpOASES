...
extern "C" void r_dpotrf_(	const char* uplo, const la_uint_t* _n, double* a,
...
extern "C" void r_spotrf_(	const char* uplo, const la_uint_t* _n, float* a,
							const la_uint_t* _lda, la_int_t* info
							)
{
	float sum;
...
extern "C" void r_dtrtrs_(	const char* UPLO, const char* TRANS, const char* DIAG,
...
extern "C" void r_strtrs_(	const char* UPLO, const char* TRANS, const char* DIAG,
							const la_uint_t* N, const la_uint_t* NRHS,
...
extern "C" void r_dtrcon_(	const char* NORM, const char* UPLO, const char* DIAG,
...
extern "C" void r_strcon_(	const char* NORM, const char* UPLO, const char* DIAG,
